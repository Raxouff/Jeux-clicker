let terre = document.querySelector('.terre');
...
// let terreclick = document.querySelector('.terreclicker');
let index = 0;
let click=1;
let  prix_1=10;
let prix_2= 300;
...
terre.addEventListener("click",pointage);
...
// ajouter la valeur aléatoir lors d'un click sur la terre

terre.addEventListener("click",clickterre)
